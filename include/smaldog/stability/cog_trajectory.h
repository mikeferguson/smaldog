...
#ifndef SMALDOG_STABILITY_FAST_COG_TRAJECTORY_H_
#define SMALDOG_STABILITY_FAST_COG_TRAJECTORY_H_
 ...
 */
bool computeCOGShift(const RobotState& state, KDL::Vector& shift);
